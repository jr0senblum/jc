...
%%% gen_server to provide a set of seatialized opperations.
%%%
%%% A sequence parameter is used to ensure that PUT's and 'EVICTS' are 
%%% serialized according to map-specific, sequence numbers. Because this 
%%% involves ACID-level transactions, the functions in this module are much
%%% slower than those in {@link jc. jc}
%%%
